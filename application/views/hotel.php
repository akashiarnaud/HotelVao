...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(<?php echo base_url();?>/assets/img/hero_2.jpg)">
      <div class="container">
    ...
    <section class="bg-light">
		<?php foreach($contenu as $c){?>
      <div class="half d-md-flex d-block">
        <div class="image" data-aos="fade" style="background-image: url('<?php echo base_url();?>assets/img/<?php echo $c['image'];?>');"></div>
